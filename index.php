...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Advent+Pro|Basic|Fjalla+One|Lobster|Shrikhand" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Advent+Pro|Basic|Crete+Round|Fjalla+One|Lobster|Patua+One|Shrikhand"
        rel="stylesheet">
    <link href='https://fonts.googleapis.com/css?family=Roboto+Slab:400,100,300,700' rel='stylesheet' type='text/css'>
    <link href="https://fonts.googleapis.com/css?family=Advent+Pro|Basic|Lobster|Shrikhand" rel="stylesheet">
...
<body>
    <div class="outerDiv" id="home">
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top my-nav-last" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">BrainStomer</a>
        ...
        <div class="test-container-phoenix">
            ...
            <div class="container test-container">
                <div class="row row-footer">
                    ...
                    <div class="col-lg-4 col-sm-6 col-footer">
                        <br>
                        <br>The official technical club of Netaji Subhash Engineering College was founded by a group of individuals
                        in January 2006, who thought about the nagging problems regarding placements & jobs.
                        <p>
                            PHOENIX by means of its various activities tries to bridge the gap between the illustrious student and the efficient professional-
                            be it in the software or core sector.
                    </div>
                    <div class="col-lg-4 col-sm-6 col-footer">
                        <br>
                        <br>What started as a platform for people to come and share their ideas, has now diversified into an
                        entity,
                        <p>

                            which by means of its many activities, has provided an unlimited impetus to the esteem of our college.
                    </div>
                </div>
            </div>
        </div>
<!-- ============================================================================================================= -->
        <div class="test-container-brainstomer">
            <h1>
                <center class="bg-hd">BrainStomer</center>
            </h1>
            <div class="container test-container">
                <div class="row row-footer">
                    <div class="col-lg-4 col-sm-6 col-footer">
                    ...
                    <div class="col-lg-4 col-sm-6 col-footer">
                        <br>
                        <br> Annual inter-college quiz is an event of great importance, as it symbolizes the impetus our college
                        has provided to the quizzing scenario. Sponsored by Indian Oil, it first started in 2007 at the Techno
                        India, Salt Lake Hall. Last year in 2008, </div>
                    <div class="col-lg-4 col-sm-6 col-footer">
                        <br>
                        <br>it was a massive success with over 80 undergraduate colleges participating from in and around Kolkata,
                        and prizes worth Rs 25000 being given away. It has now become a brand name in the quizzing circles
...
<!-- =================================================================================================================== -->
    ...
    <div class="gallery" id="gallery">
        <center>
            ...
            <br>
            <p class="gallery-sbhd">The most beutiful things are not associated with money ; they are memories and moments.</p>
        </center>
...
<!-- <==============================================================================================================>    -->
    	...
    	if ($_SERVER["REQUEST_METHOD"] == "POST") {
    		...
    		if($errorfree==0){
                ...
                ?><script> alert("Please provide the Information Correctly");</script><?php
    		}	
    	}
            ...
            <div class="myfooter" id="contact">
                <div class="container">
                    <div class="row row-footer">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-footer">
                            ...
                            <p>
                                <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;&nbsp;+91000000000</p>
                            <p>
                                <i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;Email:xyz@gmail.com</p>


                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-footer">
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ullam dignissimos enim neque. Reiciendis, delectus error. Animi
                ...
                <div class="bottom-footer">
                    <div class="row row-footer-bottom">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <i class="fa fa-copyright" aria-hidden="true"></i>&nbsp;&nbsp; 2019 Phoenix. All Rights Reserved | Developed By:
                            <span class="tool">
                                <span class="tootext">
                                    <a href="https://www.facebook.com/aniketjha1729">
                                        <i title="Aniket Kumar" class="fa fa-user-circle" aria-hidden="true"></i>&nbsp;&nbsp;
                                    </a>
                                </span>
                            </span>
                            <span class="tool">
                                <span class="tootext">
                                    <a href="https://www.facebook.com/shashwat3057">
                                        <i title="Shashwat Sinha" class="fa fa-user-circle" aria-hidden="true"></i>&nbsp;&nbsp;
                                    </a>
                                </span>
                            </span>
                            <span class="tool">
                                <span class="tootext">
                                    <a href="https://www.facebook.com/say.hello.to.anurag">
                                        <i title="Anurag Singh" class="fa fa-user-circle" aria-hidden="true"></i>&nbsp;&nbsp;
                                    </a>
                                </span>
                            </span>
                        </div>
